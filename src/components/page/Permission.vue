...
export default {
    ...
    methods: {
        ...
        //获取所有前台
        getAllFront () {
            this.$http.get('http://localhost:8081/getAllFront').then((res) => {
                //console.log(res);
        ...
        handleDelete (index, row, typeId) {
            if (localStorage.getItem('ms_username') === 'admin') {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        this.$http.delete('http://localhost:8081//deleteFront?id=' + typeId).then((res) => {
                            console.log(res);
        ...
        saveFront () {
            ...
            this.$http.post('http://localhost:8081/addFront?frontId=' + this.form.frontId + '&name=' + this.form.name + '&password=' + this.form.password + '&phone=' + this.form.phone).then(res => {
                //console.log(res);
                if (res.data.code === 200) {
                    //1.提示成功
