...
export default {
    ...
    methods: {
        ...
        saveRoomEdit () {
            ...
            this.$http.post('http://:8081/addRoom?position=' + this.form.position + '&roomId=' + this.form.roomId + '&typeId=' + this.form.typeId).then(res => {
                console.log(res);
        ...
        saveRoom () {
            // console.log(this.form);
            this.$http.post('http://localhost:8081/addRoom?position=' + this.form.position + '&roomId=' + this.form.roomId + '&typeId=' + this.form.typeId).then(res => {
                //console.log(res);
                if (res.data.code === 200) {
                    //1.提示成功
        ...
        // 搜索功能
        handleSearch () {
            this.$http.get('http://localhost:8081/getRoomById?id=' + this.rooms.roomId).then(res => {
