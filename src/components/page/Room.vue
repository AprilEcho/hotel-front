  ...
  export default {
    ...
    methods: {
      ...
      sureCost(costTypesId) {
        ...
        this.$http.post('http://localhost:8081/addCost?costTypeId=' + costTypesId + '&id=0&roomId=' + this.costTypes.serviceNeedRooId).then(res => {
          console.log(res);
      ...
      //获取所有消费信息
      getAllCostType() {
        this.$http.get('http://localhost:8081/getAllCostType').then((res) => {
          //console.log(res);
      ...
      surePay() {
        ...
        this.$http.post('http://localhost:8081/settleCostByRoomId?roomId=' + this.form.roomIdPay).then(res => {
          console.log(res);
          if (res.data.code === 200) {
            //1.提示成功
      ...
      inspect(roomId) {
        ...
        this.$http.post('http://localhost:8081/getCostByRoomId?roomId=' + roomId).then(res => {
          //console.log(res);
      ...
      checkOut(checkroomId) {
        ...
        this.$http.post('http://localhost:8081/checkOut?roomId=' + checkroomId).then(res => {
          console.log(res);
          if (res.data.code === 200) {
            //1.提示成功
      ...
      saveRoomEdit() {
        ...
        if (this.form.maxNum > 0 && this.form.earnest > 0 && this.form.rent > 0 && this.form.size > 0) {
          this.$http.post('http://localhost:8081/addRoom?earnest=' + this.form.earnest + '&roomId=' + this.form.roomId + '&maxNum=' + this.form.maxNum + '&rank=' + this.form.rank + '&rent=' + this.form.rent + '&size=' + this.form.size + '&position=' + this.form.position).then(res => {
            //console.log(res);
            if (res.data.code === 200) {
              //1.提示成功
      ...
      handleDelete(index, row, roomId) {
        if (localStorage.getItem('ms_username') === 'admin') {
          ...
          this.$confirm('确定要删除吗？', '提示', {
            ...
            .then(() => {
              this.$http.delete('http://localhost:8081/deleteRoom?id=' + roomId).then((res) => {
                if (res.data.code === 200) {
      ...
      saveBook() {
        //console.log(this.form);
        this.$http.post('http://localhost:8081/addGuest?contact=' + this.form.contact + '&idCard=' + this.form.idCard + '&name=' + this.form.name).then(res => {
          //console.log(res);
          if (res.data.code === 200) {
            //1.提示成功
            this.$message.success(`添加成功`);
      ...
      // 搜索功能
      handleSearch() {
        this.$http.get('http://localhost:8081/getRoomById?id=' + this.roomMsgs.roomId).then(res => {
      ...
      //获取已经入住的房间
      getHasCheckedRoom() {
        this.$http.get('http://localhost:8081/getHasCheckedRoom').then(res => {
          if (res.data.data === null) {
