<template>
    <div class="login-wrap">
        <div class="ms-login">
            <div class="ms-title">小型酒店管理系统</div>
            <el-form :model="param" :rules="rules" ref="login" label-width="0px" class="ms-content">
                ...
                <div class="login-btn">
<!--                    <el-button type="primary" @click="trivalindex()">游客</el-button>-->
                </div>
...
export default {
    ...
    methods: {
        trivalindex(){
            localStorage.setItem('token', 'trivel');
            localStorage.setItem('ms_username', 'trivel');
            this.$router.push('/travelindex')
        },
        submitForm () {
